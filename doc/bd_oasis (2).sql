...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-01-2023 a las 14:51:20
...
INSERT INTO `comentario` (`id_comentario`, `contenido`, `calificacion`, `fecha_comentario`, `fk_servicio`) VALUES
(1, 'este tratamiento muuuy bueno', 9, '2022-12-23 00:20:10', 1),
(8, 'esta re lindo el lugar!', 7, '2022-12-24 00:20:16', 2),
(9, 'no me gusto la atencion del personal', 3, '2022-12-25 00:20:21', 11),
(14, 'me encanto', 8, '2022-12-26 00:22:29', 6),
(15, 'la calidad no es tan buena', 5, '2022-12-27 00:23:28', 9),
(16, 'que relajaciooon', 7, '2022-12-28 00:26:04', 10);
...
CREATE TABLE `comentario_x_producto` (
  `id_xcomentario` int(11) NOT NULL,
  `fk_servicio` int(11) NOT NULL,
...
CREATE TABLE `compra` (
  ...
  `fk_servicio_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `compra` (`compra_id`, `fecha_compra`, `total`, `fk_servicio_id`) VALUES
...
INSERT INTO `usuario` (`usuario_id`, `nombre`, `apellido`, `email`, `password`, `telefono`, `fecha_nac`, `puntos`, `fk_tipo_id`) VALUES
(1, 'Vanesa', 'Martinez', 'vanmar@gmail.com', '1234', '1254-4789', '1980-11-01 03:00:28', 55, 1),
(3, 'Matias', 'Artiga', 'matiart@gmail.com', '1234', '1254-4756', '1956-10-05 00:00:00', 120, 1),
(5, 'Camila', 'Estuardo', 'camiestuardo@gmail.com', '1234', '1254-1259', '1999-08-17 00:00:00', 80, 2),
(8, 'valeria', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(9, 'valeria', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(10, 'valeria', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(11, 'valeria', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(12, 'valeria', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(13, 'valeria', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(14, '', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL),
(15, 'vanea', '', 'vanmar@gmail.com', '1234', NULL, NULL, NULL, NULL);
...
ALTER TABLE `compra`
  ...
  ADD KEY `fk_servicio_id` (`fk_servicio_id`);
...
--
ALTER TABLE `comentario_x_producto`
  MODIFY `id_xcomentario` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `comentario`
  ADD CONSTRAINT `servicio_fk` FOREIGN KEY (`fk_servicio`) REFERENCES `servicio` (`servicio_id`);
...
--
ALTER TABLE `compra`
  ADD CONSTRAINT `compra_ibfk_1` FOREIGN KEY (`fk_servicio_id`) REFERENCES `servicio` (`servicio_id`);
