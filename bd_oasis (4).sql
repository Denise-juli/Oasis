...
--
-- Servidor: localhost
-- Tiempo de generación: 01-03-2023 a las 14:06:49
...
INSERT INTO `comentario` (`id_comentario`, `contenido`, `calificacion`, `fk_servicio_id`, `usuario_id`) VALUES
(1, 'este tratamiento muuuy bueno', 9, 1, 0),
(8, 'esta re lindo el lugar!', 7, 2, 0),
(9, 'no me gusto la atencion del personal', 3, 11, 0),
(14, 'me encanto', 8, 6, 0),
(15, 'la calidad no es tan buena', 5, 9, 0),
(16, 'que relajaciooon', 7, 10, 0),
(23, 'hola', 9, 1, 3),
(28, 'dafsd', 8, 1, 0),
(29, 'adfad', 8, 1, 0),
(30, '<dfd', 8, 1, 0),
...
ALTER TABLE `comentario`
  ...
  ADD KEY `servicio_fk` (`fk_servicio_id`);
...
--
ALTER TABLE `comentario`
  ADD CONSTRAINT `fk_servicio_id` FOREIGN KEY (`fk_servicio_id`) REFERENCES `servicio` (`servicio_id`),
  ADD CONSTRAINT `servicio_fk` FOREIGN KEY (`fk_servicio_id`) REFERENCES `servicio` (`servicio_id`);
